...
> [!NOTE]
> **Metaphor Transparency:** In this document, **potentiation / LTP** and **depression / LTD** are descriptive metaphors for the underlying reinforce-in-place (`COMP(term, term)`) and decay (`SHIFT` by η) operations.
