#!/usr/bin/env bash
# live.sh — MST door: talk to a standard AI model that LEARNS AS YOU TALK.
# Every turn is a live experience (~10s on this checkpoint): your words train it at full weight, its
